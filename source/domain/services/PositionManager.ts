...
export abstract class PositionManager {
  abstract updatePositions(nodes: Node[]): TEither<TApplicationError, Record<NodeId, Position>>;
  abstract updateTargetPosition(node: Node): TEither<TApplicationError, Record<NodeId, Position>>;
